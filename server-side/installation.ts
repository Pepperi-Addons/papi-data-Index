...
export async function upgrade(client: Client, request: Request): Promise<any> {
    ...
    if(request.body.FromVersion && semver.compare(request.body.FromVersion, '1.1.19') < 0 || request.body.FromVersion && semver.compare(request.body.FromVersion, '1.2.10') < 0) 
    {
